...
pub struct RolePositionsParameters {
    ...
    pub left_midfielder_minimum_x_ball_is_not_free_no_kickoff: f32,
    pub left_midfielder_maximum_x_ball_is_not_free_no_kickoff: f32,
    pub left_midfielder_minimum_x_ball_is_free: f32,
    pub right_midfielder_distance_to_ball: f32,
    pub right_midfielder_minimum_x_ball_is_not_free_no_kickoff: f32,
    pub right_midfielder_maximum_x_ball_is_not_free_no_kickoff: f32,
    pub right_midfielder_minimum_x_ball_is_free: f32,
    pub striker_supporter_distance_to_ball: f32,
    pub striker_supporter_minimum_x_ball_is_not_free_no_kickoff: f32,
    pub striker_supporter_maximum_x_ball_is_not_free_no_kickoff: f32,
    pub striker_supporter_minimum_x_ball_is_free: f32,
