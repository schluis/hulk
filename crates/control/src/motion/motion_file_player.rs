...
use types::{
    ...
    motion_file_player::InterpolatedMotion,
...
impl Motion<MotorCommands<Joints<f32>>> {
    pub fn state(&self) -> InterpolatedMotion {
        InterpolatedMotion {
...
impl Motion<Joints<f32>> {
    pub fn state(&self, stiffness: f32) -> InterpolatedMotion {
...
pub struct MainOutputs {
    pub arms_up_squat: MainOutput<InterpolatedMotion>,
    pub jump_left: MainOutput<InterpolatedMotion>,
    pub jump_right: MainOutput<InterpolatedMotion>,
    pub sit_down: MainOutput<InterpolatedMotion>,
    pub stand_up_back: MainOutput<InterpolatedMotion>,
    pub stand_up_front: MainOutput<InterpolatedMotion>,
    pub stand_up_sitting: MainOutput<InterpolatedMotion>,
    pub stand_up_squatting: MainOutput<InterpolatedMotion>,
}
