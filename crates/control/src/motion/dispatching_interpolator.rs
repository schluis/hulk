...
pub struct CycleContext {
    arms_up_squat: Input<InterpolatedMotion, "arms_up_squat">,
    jump_left: Input<InterpolatedMotion, "jump_left">,
    jump_right: Input<InterpolatedMotion, "jump_right">,
    sit_down: Input<InterpolatedMotion, "sit_down">,
    stand_up_back: Input<InterpolatedMotion, "stand_up_back">,
    stand_up_front: Input<InterpolatedMotion, "stand_up_front">,
    stand_up_sitting: Input<InterpolatedMotion, "stand_up_sitting">,
    stand_up_squatting: Input<InterpolatedMotion, "stand_up_squatting">,
