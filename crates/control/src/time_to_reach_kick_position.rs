...
pub struct CycleContext {
    ...
    stand_up_sitting_remaining_duration: Input<Duration, "stand_up_sitting.remaining_duration">,
    stand_up_squatting_remaining_duration: Input<Duration, "stand_up_squatting.remaining_duration">,
...
impl TimeToReachKickPosition {
    ...
    pub fn cycle(&mut self, mut context: CycleContext) -> Result<MainOutputs> {
        ...
        let time_to_stand_up = match context.motion_selection.current_motion {
            ...
            MotionVariant::StandUpSitting => *context.stand_up_sitting_remaining_duration,
            MotionVariant::StandUpSquatting => *context.stand_up_squatting_remaining_duration,
            _ => Duration::ZERO,
        };
